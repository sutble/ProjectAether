...
public class SteamVR_SimplePointer : SteamVR_WorldPointer
{
    ...
    protected override void Update()
    {
        ...
        {
            Ray pointerRaycast = new Ray(transform.position, -transform.up);
    ...
    private void SetPointerTransform(float setLength, float setThicknes)
    {
        ...
        pointerTip.transform.localPosition = new Vector3(0f, -(setLength - (pointerTip.transform.localScale.z / 2)), 0f);
